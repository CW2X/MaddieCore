    ...
    switch (targetType.GetTarget())
    {
		...
		case TARGET_DEST_CASTER_FRONT_LEAP:
		{
			...
			else
			{
				...
				bool col = VMAP::VMapFactory::createOrGetVMapManager()->getObjectHitPos(mapid, pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ() + 0.5f, destx, desty, pos.GetPositionZ() + 0.5f, destx, desty, z, -0.5f);
				// check dynamic collision
				bool dcol = m_caster->GetMap()->getObjectHitPos(phasemask, pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ() + 0.5f, destx, desty, z + 0.5f, destx, desty, z, -0.5f);
