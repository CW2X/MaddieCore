            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 5:
                        ...
                        break;
                    default:
					//	TC_LOG_ERROR("Unexpected movement variation  in npc_og_suitAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 18:
                        ...
                        break;
                    default:
						TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_infantryAI::SetupMovement call!");
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
						TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_tankAI::SetupMovement call!");
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
						TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_i_tankAI::SetupMovement call!");
                        return;
                }
        ...
        struct npc_og_mekkatorqueAI : public npc_escortAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                if (uiStep_timer <= diff)
                {
                    ...
                    {
                        case 1:
                            me->Say(MEK_1_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(9000);
                            break;
                        case 2:
							me->Say(MEK_1_3, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(5000);
                            break;
                        case 3:
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
							me->Say(MEK_3_2, LANG_UNIVERSAL, NULL);
                        ...
                        case 10:
                            ...
                            break;
                        case 11:
                            me->Yell(MEK_4_2, LANG_UNIVERSAL, NULL);
                            DoPlayMusic(1);
                        ...
                        case 12:
                            ...
                            break;
                        case 14:
                            me->Say(MEK_5_2, LANG_UNIVERSAL, NULL);
                            ...
                            break;
                        case 15:
                            me->Say(MEK_5_3, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(7000);
                            break;
                        case 16:
                            SetHoldState(false);
                            break;
                        case 18:
							me->Say(MEK_10_2, LANG_UNIVERSAL, NULL);
                            ...
                            break;
                        case 19:
							me->Say(MEK_10_3, LANG_UNIVERSAL, NULL);
                        ...
                        case 22:
                            ...
                            break;
                        case 23:
							me->Say(MEK_12_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(8500);
                            break;
                        case 24:
                            SetHoldState(false);
                        ...
                        case 28:
                            ...
                            break;
                        case 30:
							me->Say(MEK_13_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(8000);
                            break;
                        case 31:
							me->Say(MEK_13_3, LANG_UNIVERSAL, NULL);
                            for (int32 n = 0; n < 3; ++n)
                        ...
                        case 33:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
                                pBragBot->Yell(THERM_1_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(5000);
                            break;
                        case 34:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_1_3, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(3000);
                            break;
                        case 35:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_1_4, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(4500);
                            break;
                        case 36:
                            ...
                            if (uiTroggs <= 20)
                            {
                                ...
                                switch (uiTroggs)
                                {
                                    case 2:
                                        ...
                                        break;
                                    case 5:
										me->Yell(MEK_14_2, LANG_UNIVERSAL, NULL);
                                        break;
                                }
                        ...
                        case 59:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_2_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(3000);
                            break;
                        case 60:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_2_3, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(5000);
                            break;
                        case 61:
                        ...
                        case 63:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_3_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(7000);
                            break;
                        case 64:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_3_3, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(2000);
                            break;
                        case 65:
                            if (Creature* pBragBot = me->FindNearestCreature(NPC_BRAG_BOT, 20, true))
								pBragBot->Yell(THERM_3_4, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(8000);
                            break;
                        case 66:
                        ...
                        case 67:
                            ...
                            break;
                        case 68:
                            me->Say(MEK_19_2, LANG_UNIVERSAL, NULL);
                            me->Dismount();
                        ...
                        case 76:
                            ...
                            break;
                        case 77:
                            me->Say(MEK_21_2, LANG_UNIVERSAL, NULL);
                            JumpToNextStep(10000);
                            break;
                        case 78:
            ...
            void SpecialKill(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
						TC_LOG_ERROR("scripts", "Unexpected variation (%i) in npc_og_mekkatorqueAI::SpecialKill call!");
                }
            }
            ...
            {
                if (yell)
                    pTalker->Yell(text, LANG_UNIVERSAL, NULL);
                else
                    pTalker->Say(text, LANG_UNIVERSAL, NULL);
            ...
            void DoPlayMusic(uint8 musicId)
            {
                switch (musicId)
                {
                    ...
                    case 2:
                        ...
                        break;
                    default:
						TC_LOG_ERROR("musicid", "Unexpected musicId (%i) in npc_og_mekkatorqueAI::DoPlayMusic call!");
                }
            }
            ...
            void UpdateBannerState(float radius)
            {
                ...
                if (!BannerList_temp.empty())
                {
					...
					TC_LOG_ERROR("TSCR error","BannerList is empty!");
            }
                    ...
                    for (std::list<uint64>::const_iterator itr = SummonsGUID.begin(); itr != SummonsGUID.end(); ++itr)
                        //if (Creature* summon = ObjectAccessor::GetCreature(*me, itr))
                         ...
                         //   else
						   ...
						   //dont know why this has a error
                    SummonsGUID.clear();
                }
                if (!BannerList.empty())
                {
        ...
        bool OnQuestAccept(Player* pPlayer, Creature* pCreature, Quest const* pQuest)
        {
            if (pQuest->GetQuestId() == QUEST_OPERATION_GNOMEREGAN)
            {
                if (!bProcessing)
                {
                    ...
                    pCreature->Say(MEK_1_1, LANG_UNIVERSAL, NULL);
